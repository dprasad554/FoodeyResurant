...
public class GroceryManageAddressActivity_ViewBinding implements Unbinder {
  private GroceryManageAddressActivity target;

  @UiThread
  public GroceryManageAddressActivity_ViewBinding(GroceryManageAddressActivity target) {
  ...
  @CallSuper
  public void unbind() {
    GroceryManageAddressActivity target = this.target;
