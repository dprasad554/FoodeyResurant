...
public class SnacksActivity_ViewBinding implements Unbinder {
  private SnacksActivity target;

  @UiThread
  public SnacksActivity_ViewBinding(SnacksActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SnacksActivity_ViewBinding(SnacksActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SnacksActivity target = this.target;
