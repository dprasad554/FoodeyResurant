...
public class CakeOrderSummaryActivity_ViewBinding implements Unbinder {
  private CakeOrderSummaryActivity target;

  @UiThread
  public CakeOrderSummaryActivity_ViewBinding(CakeOrderSummaryActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CakeOrderSummaryActivity_ViewBinding(CakeOrderSummaryActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CakeOrderSummaryActivity target = this.target;
