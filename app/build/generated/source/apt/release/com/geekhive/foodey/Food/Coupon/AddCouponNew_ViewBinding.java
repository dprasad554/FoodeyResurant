...
public class AddCouponNew_ViewBinding implements Unbinder {
  private AddCouponNew target;

  @UiThread
  public AddCouponNew_ViewBinding(AddCouponNew target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AddCouponNew_ViewBinding(AddCouponNew target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AddCouponNew target = this.target;
