...
public class CakeCheckOutActivityFinal_ViewBinding implements Unbinder {
  private CakeCheckOutActivityFinal target;

  @UiThread
  public CakeCheckOutActivityFinal_ViewBinding(CakeCheckOutActivityFinal target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CakeCheckOutActivityFinal_ViewBinding(CakeCheckOutActivityFinal target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CakeCheckOutActivityFinal target = this.target;
