...
public class SelectOfferActivity_ViewBinding implements Unbinder {
  private SelectOfferActivity target;

  @UiThread
  public SelectOfferActivity_ViewBinding(SelectOfferActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SelectOfferActivity_ViewBinding(SelectOfferActivity target, View source) {
    this.target = target;
    ...
    target.vTAsoName = Utils.findRequiredViewAsType(source, R.id.vT_aso_name, "field 'vTAsoName'", TextView.class);
    target.vTAsoPlace = Utils.findRequiredViewAsType(source, R.id.vT_aso_place, "field 'vTAsoPlace'", TextView.class);
    target.vTAsoTiming = Utils.findRequiredViewAsType(source, R.id.vT_aso_timing, "field 'vTAsoTiming'", TextView.class);
    target.vTAsoOffer = Utils.findRequiredViewAsType(source, R.id.vT_aso_offer, "field 'vTAsoOffer'", TextView.class);
    target.vTAsoTable = Utils.findRequiredViewAsType(source, R.id.vT_aso_table, "field 'vTAsoTable'", TextView.class);
    target.vRAsoList = Utils.findRequiredViewAsType(source, R.id.vR_aso_list, "field 'vRAsoList'", RecyclerView.class);
  ...
  @CallSuper
  public void unbind() {
    SelectOfferActivity target = this.target;
    ...
    target.vTAsoName = null;
    target.vTAsoPlace = null;
    target.vTAsoTiming = null;
    target.vTAsoOffer = null;
    target.vTAsoTable = null;
    target.vRAsoList = null;
