...
public class OrderSummaryActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public OrderSummaryActivity_ViewBinding(OrderSummaryActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public OrderSummaryActivity_ViewBinding(OrderSummaryActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    OrderSummaryActivity target = this.target;
