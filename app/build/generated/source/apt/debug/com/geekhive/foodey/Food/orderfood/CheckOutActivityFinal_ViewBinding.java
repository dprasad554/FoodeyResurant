...
public class CheckOutActivityFinal_ViewBinding implements Unbinder {
  private CheckOutActivityFinal target;

  @UiThread
  public CheckOutActivityFinal_ViewBinding(CheckOutActivityFinal target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CheckOutActivityFinal_ViewBinding(CheckOutActivityFinal target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CheckOutActivityFinal target = this.target;
