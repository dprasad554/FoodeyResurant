...
public class CheckOutActivityTakeAway_ViewBinding implements Unbinder {
  private CheckOutActivityTakeAway target;

  @UiThread
  public CheckOutActivityTakeAway_ViewBinding(CheckOutActivityTakeAway target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CheckOutActivityTakeAway_ViewBinding(CheckOutActivityTakeAway target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CheckOutActivityTakeAway target = this.target;
