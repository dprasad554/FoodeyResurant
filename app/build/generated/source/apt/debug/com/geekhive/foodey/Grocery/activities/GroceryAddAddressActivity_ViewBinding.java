...
public class GroceryAddAddressActivity_ViewBinding implements Unbinder {
  private GroceryAddAddressActivity target;

  @UiThread
  public GroceryAddAddressActivity_ViewBinding(GroceryAddAddressActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public GroceryAddAddressActivity_ViewBinding(GroceryAddAddressActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    GroceryAddAddressActivity target = this.target;
