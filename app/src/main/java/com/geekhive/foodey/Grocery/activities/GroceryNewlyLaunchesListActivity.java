...
import com.geekhive.foodey.Grocery.adapter.NewlunchesAdapter;
...
public class GroceryNewlyLaunchesListActivity extends AppCompatActivity implements OnResponseListner {

    Toolbar toolbar;
    RecyclerView newlyLaunches;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.grocery_activity_launches_list);
      ...
      //  CallOfferService();
        //For Recent Purchase
        newlyLaunches = (RecyclerView)findViewById(R.id.newlyLaunches_);


        GridLayoutManager gridLayoutManager = new GridLayoutManager(this,2,LinearLayoutManager.VERTICAL,false);
        newlyLaunches.setLayoutManager(gridLayoutManager);
        NewlunchesAdapter newlunchesadapter = new NewlunchesAdapter(this);
        newlyLaunches.setAdapter(newlunchesadapter);
...
//        }
    ...
    public class GroceryNewlyLaunchedViewallAdapter extends RecyclerView.Adapter<GroceryNewlyLaunchedViewallAdapter.ViewHolder> {

        //Variables
        private Context mcontext;
        GroceryOffer groceryOffer;

        public GroceryNewlyLaunchedViewallAdapter(Context context) {
