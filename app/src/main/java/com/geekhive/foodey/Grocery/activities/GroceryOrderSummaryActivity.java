...
public class GroceryOrderSummaryActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.grocery_activity_order_summary);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.vI_tl_back:
                startActivity(new Intent(GroceryOrderSummaryActivity.this, GroceryBottomNavigationActivity.class));
                finish();
                break;
