...
import com.geekhive.foodey.Food.directionhelpers.FetchURL;
import com.geekhive.foodey.Food.directionhelpers.TaskLoadedCallback;
import com.geekhive.foodey.Food.utils.ConnectionDetector;
import com.geekhive.foodey.Food.utils.GitApi;
...
public class TrackingActivity extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback, View.OnClickListener, OnResponseListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracking_copy);
    ...
    private void setvalues() {
        ...
        disposable = Observable.interval(1000, 50000,
    ...
    private void callLocationUpdate(Long aLong) {
        ...
        Observable<UserLocation> observable = apiService.getUserLocation(MultipartBody.Part.createFormData("order_id", order_id));
    ...
    private void CallService() {
        if (this.mDetector.isConnectingToInternet()) {
            new WebServices(this).TrackLocation(WebServices.Foodey_Services,
        ...
        if (this.mDetector.isConnectingToInternet()) {
            ...
            if (!Prefs.getUserId(this).isEmpty() || !Prefs.getUserId(this).equals("")){
                new WebServices(this).OrderHistory(WebServices.Foodey_Services,
                        WebServices.ApiType.orderHistory, Prefs.getUserId(this));
            } else {
    ...
    public void onResponse(Object response, WebServices.ApiType apiType, boolean isSucces) {
        if (apiType == WebServices.ApiType.tracklocation) {
            if (!isSucces) {
                ...
                TrackLocation trackLocation = (TrackLocation) response;
                if (trackLocation != null){
                    if (trackLocation.getDetails() != null){
                        ...
                        new FetchURL(TrackingActivity.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "driving"), "driving");
            ...
            if (!isSucces) {
                ...
                UserLocation userLocation = (UserLocation) response;
                if (userLocation != null){
                    if (userLocation.getAddress() != null){
                        userLat = Double.parseDouble(userLocation.getAddress().getLatitude());
                        userLang = Double.parseDouble(userLocation.getAddress().getLongitude());
        ...
        } else if (apiType == WebServices.ApiType.orderHistory) {
            if (!isSucces) {
                SnackBar.makeText(this, getResources().getString(R.string.something_wrong), SnackBar.LENGTH_SHORT).show();
            } else {
                ...
                if (orderHistory != null){
                    if (orderHistory.getOrderHistory() != null){
                        if (orderHistory.getOrderHistory().getCart().get(pos).getStatus().equals("5")){
                            statusList.add("Order confirmed");
                            statusList.add("Restaurant preparing order");
                            statusList.add("Delivery boy assigned");
                            statusList.add("Order picked");
                            statusList.add("Your food is arriving to your location");
                            statusList.add("Your food is delivered");
                        ...
                        SnackBar.makeText(this, orderHistory.getMessage(), SnackBar.LENGTH_SHORT).show();
                    }
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(TrackingActivity.this, new String[]{Manifest.permission.CALL_PHONE}, CALL_REQUEST);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == CALL_REQUEST) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(TrackingActivity.this, "Please allow calling permission", Toast.LENGTH_SHORT).show();
            }
        }
    }
