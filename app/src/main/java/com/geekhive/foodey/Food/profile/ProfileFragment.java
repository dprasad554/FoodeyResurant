...
/**
 * Created by user pc on 27-07-2018.
 */
...
public class ProfileFragment extends Fragment implements View.OnClickListener {
    ...
    @BindView(R.id.vT_fp_contactus)
    TextView vTFpContactUs;
    @BindView(R.id.vL_fp_contactus)
    LinearLayout vLFpContactUs;
    ...
    private void setTypeFace() {
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                vTFpContactUs.setTypeface(NIRMALAB);
    ...
    private void setvalues() {
        ...
        vTFpContactUs.setOnClickListener(this);
        ...
        vCallBtn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.vL_fp_cart:
                Intent intentc = new Intent(getActivity(), CheckOutActivityNew.class);
