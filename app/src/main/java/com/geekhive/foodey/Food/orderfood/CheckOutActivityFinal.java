...
import com.geekhive.foodey.Food.manageaddress.AddAddressActivity;
...
public class CheckOutActivityFinal extends AppCompatActivity implements View.OnClickListener, OnResponseListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_out_final);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.vL_coupon_l:
                ...
                if (instruction_desc != null) {
                    if (!instruction_desc.equals("")) {
                        Intent intentc = new Intent(CheckOutActivityFinal.this, AddCouponNew.class);
    ...
    private void InitializePaymentpopup() {
        paypopup = new Dialog(CheckOutActivityFinal.this);
...
//
    ...
    private void CallChecksumService() {
        if (this.mDetector.isConnectingToInternet()) {
            ...
            if (!Prefs.getUserId(this).isEmpty() || !Prefs.getUserId(this).equals("")) {
                ...
                SnackBar.makeText(CheckOutActivityFinal.this, (int) R.string.something_wrong, SnackBar.LENGTH_SHORT).show();
            }
    ...
    private void CallService() {
        if (this.mDetector.isConnectingToInternet()) {
            ...
            if (!Prefs.getUserId(this).isEmpty() || !Prefs.getUserId(this).equals("")) {
                ...
                SnackBar.makeText(CheckOutActivityFinal.this, getResources().getString(R.string.something_wrong), SnackBar.LENGTH_SHORT).show();
            }
        ...
        if (apiType == WebServices.ApiType.cartList) {
                ...
                Service.startPaymentTransaction(this, true, true,
                        new PaytmPaymentTransactionCallback() {
                            ...
                            public void onBackPressedCancelTransaction() {
                                SnackBar.makeText(CheckOutActivityFinal.this, "Back pressed. Transaction cancelled", SnackBar.LENGTH_SHORT).show();
                                //Toast.makeText(CheckOutActivityFinal.this, "Back pressed. Transaction cancelled", Toast.LENGTH_LONG).show();
                            }

                            @Override
                            public void onTransactionCancel(String inErrorMessage, Bundle inResponse) {
                                SnackBar.makeText(CheckOutActivityFinal.this, "Payment Transaction Failed! Please try again", SnackBar.LENGTH_SHORT).show();
            ...
            if (!isSucces) {
                ...
                if (paytmResponse.getMessage() != null) {
                    Intent intent = new Intent(CheckOutActivityFinal.this, OrderSummaryActivity.class);
                    intent.putExtra("deliveryType", "");
                    intent.putExtra("total", grandTotal);
            ...
            if (!isSucces) {
                ...
                SnackBar.makeText(CheckOutActivityFinal.this, updateCartItem.getMessage(), SnackBar.LENGTH_SHORT).show();
                startActivity(new Intent(CheckOutActivityFinal.this, CheckOutActivityFinal.class));
                CheckOutActivityFinal.this.finish();
            ...
            if (!isSucces) {
                ...
                SnackBar.makeText(CheckOutActivityFinal.this, removeCartItem.getMessage(), SnackBar.LENGTH_SHORT).show();
                startActivity(new Intent(CheckOutActivityFinal.this, CheckOutActivityFinal.class));
                CheckOutActivityFinal.this.finish();
            }
            ...
            if (!isSucces) {
                ...
                SnackBar.makeText(CheckOutActivityFinal.this, orderPlaced.getMessage(), SnackBar.LENGTH_SHORT);
                Intent intent = new Intent(CheckOutActivityFinal.this, OrderSummaryActivity.class);
                intent.putExtra("deliveryType", "");
                intent.putExtra("total", grandTotal);
                intent.putExtra("orderId", Prefs.getOrderId(this));
    ...
    public void callPayment() {
        if (payResponse.getString("STATUS").equals("TXN_SUCCESS")) {
            new WebServices(CheckOutActivityFinal.this).PaytmResponse(WebServices.Foodey_Services,
    ...
    public class DishAdapter extends RecyclerView.Adapter<DishAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            Prefs.setOrderId(CheckOutActivityFinal.this, cartList.getCartList().getCart().getOrderId());
