...
public class CakeOtherRecyclerAdapter extends RecyclerView.Adapter<CakeOtherRecyclerAdapter.ViewHolder> {
    //Variables
    private Context mcontext;
    CakeProductlist productlist;
    String url = "";

    public CakeOtherRecyclerAdapter(Context context, CakeProductlist productlist) {
