...
public class CakeFlowerRecyclerViewAdapter extends RecyclerView.Adapter<CakeFlowerRecyclerViewAdapter.ViewHolder>{
    //Variables
    private Context mcontext;
    ArrayList<String> titlesNames;
    ArrayList<Integer> cakesImages;

    public CakeFlowerRecyclerViewAdapter(Context context, ArrayList<String> titlesNames, ArrayList<Integer> cakesImages) {
