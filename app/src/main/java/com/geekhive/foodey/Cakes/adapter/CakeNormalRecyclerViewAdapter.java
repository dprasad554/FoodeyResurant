...
public class CakeNormalRecyclerViewAdapter extends RecyclerView.Adapter<CakeNormalRecyclerViewAdapter.ViewHolder> {
    ...
    public CakeNormalRecyclerViewAdapter(Context context, ArrayList<String> titlesNames, ArrayList<Integer> cakesImages) {
