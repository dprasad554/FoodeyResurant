...
public class CakeSpecialRecyclerAdapter extends RecyclerView.Adapter<CakeSpecialRecyclerAdapter.ViewHolder> {
    ...
    public CakeSpecialRecyclerAdapter(Context context, CakeProductlist productlist) {
