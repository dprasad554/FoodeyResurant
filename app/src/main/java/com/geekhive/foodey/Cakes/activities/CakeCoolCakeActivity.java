...
import com.geekhive.foodey.Cakes.adapter.CakeCoolListRecyclerAdapter;
import com.geekhive.foodey.R;

import java.util.ArrayList;

public class CakeCoolCakeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cake_activity_coolcake);
        ...
        specialRecyclerView = findViewById(R.id.cool_recyclerView);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this,LinearLayoutManager.VERTICAL,false);
        specialRecyclerView.setLayoutManager(linearLayoutManager);
        CakeCoolListRecyclerAdapter coolAdapter = new CakeCoolListRecyclerAdapter(this,titlesNames,cakesImages);
        specialRecyclerView.setAdapter(coolAdapter);
    }
