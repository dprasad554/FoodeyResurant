...
public class CakeCoolRecyclerViewAdapter extends RecyclerView.Adapter<CakeCoolRecyclerViewAdapter.ViewHolder> {
    ...
    public CakeCoolRecyclerViewAdapter(Context context, CakeProductlist productlist) {
