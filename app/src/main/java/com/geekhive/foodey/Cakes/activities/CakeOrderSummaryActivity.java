...
public class CakeOrderSummaryActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cake_activity_order_summary);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.vI_tl_back:
                startActivity(new Intent(CakeOrderSummaryActivity.this, CakeBottomNavigationActivity.class));
                finish();
                break;
