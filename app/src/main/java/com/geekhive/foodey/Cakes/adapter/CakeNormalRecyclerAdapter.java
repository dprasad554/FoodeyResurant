...
public class CakeNormalRecyclerAdapter extends RecyclerView.Adapter<CakeNormalRecyclerAdapter.ViewHolder> {
    ...
    public CakeNormalRecyclerAdapter(Context context, CakeProductlist productlist) {
