...
import com.geekhive.foodey.Cakes.activities.CakeCheckOutActivityNew;
...
public class CakeProfileFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.vL_fp_cart:
                Intent intentc = new Intent(getActivity(), CakeCheckOutActivityNew.class);
